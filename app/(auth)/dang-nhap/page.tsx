    ...
    <div className="w-full max-w-sm">
      <form action={loginAction} className="space-y-4 rounded-2xl glass p-6 ring-gold">
        <div className="text-center">
          ...
          <p className="mt-1 text-xs text-muted">Chào mừng trở lại Super Trading</p>
        </div>
        ...
        <div className="relative">
          ...
          <input name="password" type="password" required placeholder="Mật khẩu" aria-label="Mật khẩu" className={inputCls} />
        </div>
