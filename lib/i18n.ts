...
const vi: Dict = {
  ...
  "deposit.scanWallet": "Mở app ví (Binance, Trust, MetaMask…) quét mã để lấy địa chỉ",
...
const en: Dict = {
  ...
  "deposit.scanWallet": "Open your wallet app (Binance, Trust, MetaMask…) and scan to fill the address",
  "deposit.bank": "Bank",
